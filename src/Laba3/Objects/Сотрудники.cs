...
namespace IIS.Laba3
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private int fУдостоверение;
        
        private int fIDСотрудника;
        
        private string fФИО;
        
        private IIS.Laba3.Должности fДолжности;
        ...
        /// Удостоверение.
        /// </summary>
        // *** Start programmer edit section *** (Сотрудники.Удостоверение CustomAttributes)

        // *** End programmer edit section *** (Сотрудники.Удостоверение CustomAttributes)
        public virtual int Удостоверение
        {
            get
            {
                // *** Start programmer edit section *** (Сотрудники.Удостоверение Get start)

                // *** End programmer edit section *** (Сотрудники.Удостоверение Get start)
                int result = this.fУдостоверение;
                // *** Start programmer edit section *** (Сотрудники.Удостоверение Get end)

                // *** End programmer edit section *** (Сотрудники.Удостоверение Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Сотрудники.Удостоверение Set start)

                // *** End programmer edit section *** (Сотрудники.Удостоверение Set start)
                this.fУдостоверение = value;
                // *** Start programmer edit section *** (Сотрудники.Удостоверение Set end)

                // *** End programmer edit section *** (Сотрудники.Удостоверение Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Laba3.Должности Должности
        {
            get
            {
                ...
                IIS.Laba3.Должности result = this.fДолжности;
